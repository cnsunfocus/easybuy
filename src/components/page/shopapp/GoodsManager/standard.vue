      ...
      <el-dialog
        ...
        <el-form ref="standardform" :model="materialform" label-width="100px">
          <el-form-item label="规格组编码">
            <el-input v-model="materialform.code" placeholder="新建后系统自动生成" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="规格组名称">
            <el-input v-model="materialform.name" placeholder="请填写规格组名称" ></el-input>
          </el-form-item>
          <el-form-item label="规格组别名">
            <el-input v-model="materialform.othername" placeholder="请填写规格组别名" ></el-input>
          </el-form-item>
        </el-form>
